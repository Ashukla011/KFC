      ...
      <div className={styles.paymentMainDiv}>
        <div className={styles.child1}>
          <div className={styles.DeleveryInfo}>
            <div className={styles.deleveryHeading}>
              {" "}
              <h1>Delevery INFO</h1>
            </div>
          ...
          <div className={styles.deveryOption}>
            <div className={styles.deleveryOptionchild_1}>
              <div className={styles.deleveryHeading2}>
                {" "}
                <h1>Delevery OPTION</h1>
              </div>
              <div className={styles.a}>
                <div className={styles.LeaveAtMyDoor}>
                  <input name="a" type="radio" /> <h4>Leave at my door</h4>
                </div>
                <br />
                <br />
                <div className={styles.instruction}>
                  <p>
                    To protect you and our team, we practice contactless
                    delivery. Your driver will leave the order at your door,
                    knock, step away, and wait at a safe distance for you to
                    collect your food.
                  </p>
                </div>
                <br />
                <br />
                <div className={styles.LeaveAtMyDoor}>
                  <input name="a" type="radio" /> <h4>Hand it to me</h4>
                </div>
          ...
          <div className={styles.DeleveryInfo2}>
            ...
            <div className={styles.InfoInput}>
              ...
              <input
                ...
                required
              />
              <div className={styles.LeaveAtMyDoor2}>
