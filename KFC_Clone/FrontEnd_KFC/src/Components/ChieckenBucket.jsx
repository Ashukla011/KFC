...
export const ChieckenBucket = () => {
    let [data,setData]=useState([])

    const getDdata=()=>{
      let res=fetch("https://vast-jade-giraffe-sock.cyclic.app/CHICKENBUCKETS")
      .then((res)=>res.json())
      .then((res)=>{
        setData(res)
        console.log(res)
   ...
   localStorage.setItem("KFC",JSON.stringify(KFCProduct))
    ...
    return (
      <div>
          <h1 style={{fontFamily:"Helvetica",fontSize:"30px"}} id="CHICKEN_BUCKETS">CHICKEN BUCKETS</h1>
          <br/>
          <br/>
          <br/>
          <br/>
