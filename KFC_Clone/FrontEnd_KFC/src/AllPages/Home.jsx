    ...
    <>
        ...
        <Box width={"100%"}>
          <Image
            ...
            alt=""
          />
          <Heading textTransform={"uppercase"} fontFamily={"Helvetica"}>welcome to kfc</Heading>
        </Box>
        <Flex
        ...
        >
          <Heading textTransform={"uppercase"} fontFamily={"Helvetica"}>browse categories</Heading>
          {/* <Box
            width="auto"
            height={"0px"}
            mt={"20px"}
